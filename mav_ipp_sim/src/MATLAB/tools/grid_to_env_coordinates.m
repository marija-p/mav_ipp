...
point_env(:,1) = point_env(:,1) * map_params.resolution + ...
  map_params.position_y - map_params.resolution/2;
point_env(:,2) = point_env(:,2) * map_params.resolution + ...
  map_params.position_x - map_params.resolution/2;
