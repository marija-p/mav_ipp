...
% (starting from 1)
point_grid(:,1) = floor(round((point_env(:,2) - map_params.position_y) / map_params.resolution, 4)) + 1;
point_grid(:,2) = floor(round((point_env(:,1) - map_params.position_x) / map_params.resolution, 4)) + 1;
